...
<head>
    ...
    <!-- SUPPRIMÉ: balise </script> orpheline -->
    ...
    <div class="sap_tabs">    
        <div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
            ...
            <div class="resp-tabs-container">
                    ...
                    <div class="facts">
                        <div class="register">
                            <form name="registration" method="post" action="" enctype="multipart/form-data">
                                ...
                                <p>Email Address </p>
                                <input type="text" class="text" value="" name="email" required> <!-- Ajout required -->
                                <p>Password </p>
                    ...
                    <div class="facts">
                        <div class="login">
                            ...
                            <form name="login" action="" method="post">
                                <input type="text" class="text" name="uemail" value="" placeholder="Enter your registered email" required> <!-- Ajout required -->
                                <a href="#" class="icon email"></a>
                                <input type="password" value="" name="password" placeholder="Enter valid password" required> <!-- Ajout required -->
                ...
                <!-- Onglet Forgot Password -->
                <div class="tab-3 resp-tab-content" aria-labelledby="tab_item-2"> <!-- Corrigé: tab-2 → tab-3 -->
                    <div class="facts">
                        <div class="login">
                            <div class="buttons"></div>
                            <form name="forgot" action="" method="post"> <!-- Nom changé pour éviter confusion -->
